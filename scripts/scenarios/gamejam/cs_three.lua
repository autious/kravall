...
local Button = 
                {
                    x=0,
                    y=0,
                    matReleased = "assets/material/gamejam/cs_three.material",
                    matPressed = "assets/material/gamejam/cs_three.material",
                    matHover = "assets/material/gamejam/cs_three.material"
                }
