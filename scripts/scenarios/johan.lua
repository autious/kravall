...
function scen:load()
    ...
    ent = staticModel( scen, -10.345926284790039, 19.054418563842773, -0.0, 0.0, -0.6382718086242676, 0.0, 0.7698111534118652, 1.0, "assets/model/static/props/hanging-street-light-short_00.bgnome", "assets/texture/static/props/hanging-street-light_00.material", "" )
