...
function scen:load()
    ...
    ent = area( scen, {0.0, 0, -0.0}, {-110.37583923339844, -60.308074951171875, -110.37583923339844, -74.36163330078125, -91.88937377929688, -74.36163330078125, -91.88937377929688, -60.308074951171875}, "" )
    scen:registerInitCallback( genF( ent, "registerEnd" ) )
    scen:registerTickCallback( genF( ent, "checkEndEnter" ) )

    ent = area( scen, {0.0, 0, -0.0}, {5.44143009185791, -106.1839828491211, 5.44143009185791, -123.3947525024414, 19.698558807373047, -123.3947525024414, 19.698558807373047, -106.1839828491211}, "" )
