...
scen.cameras["main"] = {
    view = core.glm.mat4.new(
    0.04995904117822647, -0.6747655272483826, 0.7363393902778625, -0.0,
    -0.12011250853538513, 0.7278499007225037, 0.6751353740692139, 0.0,
    -0.9915024638175964, -0.12217266857624054, -0.04468510299921036, -0.0,
    0.7015347480773926, -0.5308435559272766, -14.114748001098633, 1.0 ),
    fov = 0.8575560450553894
}
scen.cameras["scen"] = {
    view = core.glm.mat4.new(
...
function scen:load()
    ...
    ent = spotLight( scen, -51.626869201660156, 19.194425582885742, -105.14415740966797, 0.0, 1.0, 1.279515686292143e-06, 1.0, 1.0, 1.0, 0.6021386384963989, 0.30106931924819946, 18.029998779296875, 200.0, "" )
