...
function scen:load()
    ...
    ent = pointLight( scen, -26.995861053466797, 1.1770826578140259, -137.0814666748047, 1.0, 0.0, 0.0, 2.0, 5.0, "" )
    ent = pointLight( scen, -24.179119110107422, 1.1770826578140259, -137.0814666748047, 1.0, 0.0, 0.0, 2.0, 5.0, "" )
    ent = spotLight( scen, -25.0318603515625, 3.1611623764038086, -136.5491943359375, 0.0, -7.549790126404332e-08, 1.0, 0.0, 0.0, 1.0, 1.1780972480773926, 0.5890486240386963, 5.0, 50.0, "" )
    ent = spotLight( scen, -26.15380096435547, 3.1348214149475098, -136.56170654296875, 0.0, -7.549790126404332e-08, 1.0, 1.0, 0.0, 0.0, 1.1780972480773926, 0.5890486240386963, 10.0, 50.0, "" )
    ent = spotLight( scen, -26.496599197387695, 3.1611623764038086, -131.59970092773438, 0.0, -7.549790126404332e-08, 1.0, 0.0, 0.0, 1.0, 1.1780972480773926, 0.5890486240386963, 5.0, 50.0, "" )
    ent = spotLight( scen, -24.66537094116211, 3.1348214149475098, -131.59970092773438, 0.0, -7.549790126404332e-08, 1.0, 1.0, 0.0, 0.0, 1.1780972480773926, 0.5890486240386963, 10.0, 50.0, "" )
    ent = spotLight( scen, -26.36366844177246, 1.3269580602645874, -128.82984924316406, 0.0, -7.549790126404332e-08, 1.0, 1.0, 1.0, 1.0, 0.6370452642440796, 0.3185226321220398, 5.0, 50.0, "" )
    ent = spotLight( scen, -24.82302474975586, 1.3269580602645874, -128.82984924316406, 0.0, -7.549790126404332e-08, 1.0, 1.0, 1.0, 1.0, 0.6370452642440796, 0.3185226321220398, 5.0, 50.0, "" )
    ...
    ent = staticModel( scen, -25.577848434448242, -0.07840566337108612, -132.8968963623047, 0.0, 0.0, 0.0, 1.0, 1.0, "assets/model/static/props/troop-transport_00.bgnome", "assets/texture/static/props/troop-transport_00.material", "" )
