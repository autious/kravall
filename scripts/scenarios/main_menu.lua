...
function scen:load()
    ...
    ent = decal( scen, -104.34569549560547, 99.53433990478516, -154.0430450439453, 0.7071068286895752, -1.685874053691805e-07, -6.181724643283815e-08, 0.7071067690849304, 11.616280555725098, 11.616280555725098, 23.232561111450195, "assets/texture/decal/names.material", "" )
end
return scen
