...
//z = pressure
//w = rage
uniform vec4 gMoodCurves[6][13] = {{ vec4(20.0f, 0.01f, 0.01f, 0.01f), vec4(0.0f), vec4(0.0f), vec4(0.0f),vec4(0.0f),vec4(0.0f),vec4(0.0f), vec4(0.0f), vec4(0.0f), vec4(0.0f), vec4(0.0f), vec4(0.0f),vec4(0.0f) },
