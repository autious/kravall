...
void run( GLFWwindow * window )
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		GFX::Debug::DrawLine(glm::vec2(100, 50), glm::vec2(1200, 600), Colors::Red);
		...
		GFX::RenderText(glm::vec2(30, 160), glm::vec2(5, 9), Colors::Red, "The Quick Brown Fox Jumps Over The Lazy Dog");
