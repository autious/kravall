...
void run( GLFWwindow * window )
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//
		//GFX::Debug::DrawRectangle(glm::vec2(10, 10), glm::vec2(1260, 700), true, glm::vec4(0, 1, 1, 0.5f));
		...
		GFX::RenderText(glm::vec2(40, 180), glm::vec2(8, 12), glm::vec4(1, 1, 1, 1), "The Quick Brown Fox Jumps Over The Lazy Dog????");

		GFX::RenderText(glm::vec2(0, 200), glm::vec2(8, 12), glm::vec4(1, 1, 1, 1), "ABCDEFGHIJKLMNOPQRSTUVWXYZASIUHDOIASHUDIOASHDAISOHUDIASHUDIASHDIOASHUDIOASHDIASHDIASUHDIOASUHDISAHIOASUHDISAUDHIASUDHISAUHD1234567890*'^&%#!?");
		GFX::Render();
