...
namespace GFX
{
	...
	public:
		...
		*/
		...
		Main rendering loop
		*/
		void Render(FBOTexture* normalDepth, FBOTexture* diffuse, FBOTexture* specular, FBOTexture* glowMatID, int screenWidth, int screenHeight, FBOTexture* shadowMap, int current);
